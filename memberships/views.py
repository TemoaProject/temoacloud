...
from .models import UserMembership, Membership, Subscription, MembershipFeature
...
def profile_view(request):
    ...
    customer_invoice_lists = stripe.Invoice.list(customer=user_membership.stripe_customer_id)
    context = {
        'user_membership': user_membership,
        'user_subscription': user_subscription,
        'lists': customer_invoice_lists.data,
    }
...
class MembershipSelectView(LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        context['membership_feature'] = MembershipFeature.objects.all()
    ...
    def post(self, request, **kwargs):
        ...
        if user_membership.membership == selected_membership:
            if user_subscription is not None:
                messages.warning(request, """You already have this membership. Your
...
def PaymentView(request):
    ...
    if request.method == "POST":
        try:
            ...
            messages.warning(request, "An error has occurred, investigate it in the console")
